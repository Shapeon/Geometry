...
struct T3DLine {
	...
	struct TPlane { TVector3 m_v3normal;     TVector3 m_v3point; };

	struct TSphere { TVector3 m_v3center;     float m_fRadius; };
	...
	//Distance between point and center of the spheres float ComputeDistancePointToSphere(const TSphere& _krSphere,            const TVector3& _krPoint); 



		//Distance between center of the circles float ComputeDistanceCircleToCircle(const TCircle& _krCircle1,        const TCircle& _krCircle2); 

		//Distance between center of the circle and triangle float ComputeDistanceCircleToTriangle(const TCircle& _krCircle,          const TTriangle2& _krTriangle); 
